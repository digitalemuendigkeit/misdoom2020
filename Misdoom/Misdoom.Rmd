...
```{r introduction, child = '10_introduction.Rmd'}
```
```{r related-work, child='20_related-work.Rmd'}
```
```{r method, child='30_method.Rmd'}
```
```{r results, child='40_Results.Rmd'}
```
...
# Acknowledgements {-}
We would like to thank Max Geulen and Merten Wothge for their help in developing the research design as well as collecting the data.
