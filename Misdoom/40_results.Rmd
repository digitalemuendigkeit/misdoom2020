...
**2) motivate critical thinking in other users**,
**3) create a better culture of discussion in online spaces** and
...
In addition, very active participants name **enjoying debating**,
**their own experiences with bullying and discrimination**, 
**enjoying self-promotion**, as well as
**being thanked and admired by others**, e.g., by site administrators,
as motivators.

### Motivations against intervention.
Members of both groups name one main motivation not to engage in counter speech: They think it is **not worth the effort**. On top of that, members of the very active group mainly mention **fatigue** with fighting hate speech in general as something that demotivates them from engaging in counter speech.

Among the moderately active participants, a considerable number more motivations are named:

1. _A general unwillingness to participate in online communication_,
2. _a preference for alternative approaches to hate speech_, e.g. blocking the perpetrator or even reporting them to the police,
3. _the chance to be successful is perceived as too small_ and
4. _their own tendency to avoid reading comments at all_.