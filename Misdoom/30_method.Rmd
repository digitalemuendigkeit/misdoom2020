...
Each focus group was recorded on audio. The recordings were then transcribed using MAXQDA. The transcription system employed was a modified version of GAT 2 [@seltingSystemTranscribingTalkininteraction2011]. The full transcripts can be found in the accompanying github repository.[^github]
...
parttrans %>% knitr::kable(caption = "Focus group participants", booktabs=T, row.names = T) %>% column_spec(1:3, width = "20em") 
...
```{r}
kable_styling(kable(head(mtcars)))
```
